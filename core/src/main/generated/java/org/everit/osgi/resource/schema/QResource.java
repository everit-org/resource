 ...
 */
package org.everit.osgi.resource.schema;
...
public class QResource extends com.mysema.query.sql.RelationalPathBase<QResource> {
    ...
    private static final long serialVersionUID = -1131885723;

    public static final QResource resource = new QResource("resource");

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final com.mysema.query.sql.PrimaryKey<QResource> resourcePk = createPrimaryKey(id);

    public QResource(String variable) {
        super(QResource.class, forVariable(variable), "org.everit.osgi.resource.schema", "resource");
        addMetadata();
    }
    ...
    public QResource(Path<? extends QResource> path) {
        super(path.getType(), path.getMetadata(), "org.everit.osgi.resource.schema", "resource");
        addMetadata();
    }

    public QResource(PathMetadata<?> metadata) {
        super(QResource.class, metadata, "org.everit.osgi.resource.schema", "resource");
        addMetadata();
    }
